...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* Basex features */
        {"basex", "masternode", &masternode, true, true, false},
        {"basex", "listmasternodes", &listmasternodes, true, true, false},
        {"basex", "getmasternodecount", &getmasternodecount, true, true, false},
        {"basex", "masternodeconnect", &masternodeconnect, true, true, false},
        {"basex", "masternodecurrent", &masternodecurrent, true, true, false},
        {"basex", "masternodedebug", &masternodedebug, true, true, false},
        {"basex", "startmasternode", &startmasternode, true, true, false},
        {"basex", "createmasternodekey", &createmasternodekey, true, true, false},
        {"basex", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"basex", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"basex", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"basex", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"basex", "getmasternodescores", &getmasternodescores, true, true, false},
        {"basex", "mnbudget", &mnbudget, true, true, false},
        {"basex", "preparebudget", &preparebudget, true, true, false},
        {"basex", "submitbudget", &submitbudget, true, true, false},
        {"basex", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"basex", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"basex", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"basex", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"basex", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"basex", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"basex", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"basex", "checkbudgets", &checkbudgets, true, true, false},
        {"basex", "mnsync", &mnsync, true, true, false},
        {"basex", "spork", &spork, true, true, false},
#ifdef ENABLE_WALLET
...
{
    return "> basex-cli " + methodname + " " + args + "\n";
}
