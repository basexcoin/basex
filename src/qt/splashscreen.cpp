...
SplashScreen::SplashScreen(Qt::WindowFlags f, const NetworkStyle* networkStyle) : QWidget(0, f), curAlignment(0)
{
    ...
    QString titleText = tr("Basex Core");
    ...
    QString copyrightTextBSA = QChar(0xA9) + QString(" 2018-%1 ").arg(COPYRIGHT_YEAR) + QString(tr("The Basex Core developers"));
    ...
    pixPaint.setPen(QColor(196, 106, 0));
