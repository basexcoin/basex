                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("Basex Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and basex: URIs)"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About Basex Core"), this);
    aboutAction->setStatusTip(tr("Show information about Basex Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for Basex"));
    ...
    openAction->setStatusTip(tr("Open a basex: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the Basex Core help message to get a list with possible Basex command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("Basex Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Basex network", "", count));
}
...
{
    QString strTitle = tr("Basex Core"); // default title
