...
#if defined(NDEBUG)
#error "Basex cannot be compiled without assertions."
#endif
...
/** Fees smaller than this (in ubsa) are considered zero fee (for relaying and mining)
...
int64_t GetBlockValue(int nHeight)
{
    ...
    if (nHeight == 0) {
        ...
        nSubsidy = 1 * COIN;
    } else if (nHeight <= GetSporkValue(SPORK_19_COLLATERAL_3500)) {
        nSubsidy = 8.05 * COIN;
    } else if (nHeight <= GetSporkValue(SPORK_20_COLLATERAL_4300)) {
        nSubsidy = 12.1 * COIN;
    } else if (nHeight <= GetSporkValue(SPORK_21_COLLATERAL_4600)) {
        nSubsidy = 12.95 * COIN;
    } else if (nHeight <= GetSporkValue(SPORK_22_COLLATERAL_4850)) {
        nSubsidy = 13.6 * COIN;
    } else if (nHeight <= GetSporkValue(SPORK_23_COLLATERAL_5050)) {
        nSubsidy = 14.25 * COIN;
    } else if (nHeight <= GetSporkValue(SPORK_24_COLLATERAL_5300)) {
        nSubsidy = 15 * COIN;
    } else if (nHeight <= GetSporkValue(SPORK_25_COLLATERAL_5600)) {
        nSubsidy = 15.65 * COIN;
    } else if (nHeight <= GetSporkValue(SPORK_26_COLLATERAL_5950)) {
        nSubsidy = 16.05 * COIN;
    } else if (nHeight <= GetSporkValue(SPORK_27_COLLATERAL_6300)) {
        nSubsidy = 16.8 * COIN;
    } else if (nHeight <= GetSporkValue(SPORK_28_COLLATERAL_6650)) {
        nSubsidy = 17.75 * COIN;
    } else if (nHeight <= GetSporkValue(SPORK_29_COLLATERAL_7000)) {
        nSubsidy = 18.55 * COIN;
    } else if (nHeight <= GetSporkValue(SPORK_30_COLLATERAL_7350)) {
        nSubsidy = 19.15 * COIN;
    } else if (nHeight <= GetSporkValue(SPORK_31_COLLATERAL_7700)) {
        nSubsidy = 19.7 * COIN;
    } else if (nHeight <= GetSporkValue(SPORK_32_COLLATERAL_8050)) {
        nSubsidy = 20.15 * COIN;
    } else if (nHeight <= GetSporkValue(SPORK_33_COLLATERAL_8400)) {
        nSubsidy = 20.6 * COIN;
    } else if (nHeight <= GetSporkValue(SPORK_34_COLLATERAL_8750)) {
        nSubsidy = 20.65 * COIN;
    } else if (nHeight <= GetSporkValue(SPORK_35_COLLATERAL_9500)) {
        nSubsidy = 21.05 * COIN;
    } else {
        nSubsidy = 0 * COIN;
    }
