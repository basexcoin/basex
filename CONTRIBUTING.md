Contributing to Basex Core
==================================

The Basex Core project operates an open contributor model where anyone is
...
The following applies to code changes to the Basex Core project, and is not to be
confused with overall Basex Network Protocol consensus changes.

Whether a pull request is merged into Basex Core rests with the project merge
...
Patches that change Basex consensus rules are considerably more involved than
...
Where a patch set proposes to change the Basex consensus, it must have been
...
The project leader is the release manager for each Basex Core release.
