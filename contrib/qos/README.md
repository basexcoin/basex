...
This means one can have an always-on basexd instance running, and another local basexd/basex-qt instance which connects to this node and receives blocks from it.
