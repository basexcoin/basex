...
RESOURCES += src/qt/basex.qrc src/qt/basex_locale.qrc

TRANSLATIONS += src/qt/locale/basex_bg.ts \
                src/qt/locale/basex_de.ts \
                src/qt/locale/basex_en.ts \
                src/qt/locale/basex_es.ts \
                src/qt/locale/basex_fi.ts \
                src/qt/locale/basex_fr.ts \
                src/qt/locale/basex_it.ts \
                src/qt/locale/basex_ja.ts \
                src/qt/locale/basex_pl.ts \
                src/qt/locale/basex_pt.ts \
                src/qt/locale/basex_ru.ts \
                src/qt/locale/basex_sk.ts \
                src/qt/locale/basex_sv.ts \
                src/qt/locale/basex_vi.ts \
                src/qt/locale/basex_zh_CN.ts \
                src/qt/locale/basex_zh_TW.ts
