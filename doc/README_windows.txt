...
Intro
-----
Basex (BSA) is a sustainable cryptocurrency modeled after 
...
high-powered mining hardware. Basex utilizes an energy efficient proof-of-stake algorithm, 
...
Setup
-----
Unpack the files into a directory and run basex-qt.exe.

Basex Core is the original Basex client and it builds the backbone of the network.
However, it downloads and stores the entire history of Basex transactions;
