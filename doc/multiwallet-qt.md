...
In order to support loading of multiple wallets in basex-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is basex.cpp.
...
Changes to basex.cpp
----------------------
basex.cpp is the entry point into basex-qt, and as such, will require some minor modifications to provide hooks for
